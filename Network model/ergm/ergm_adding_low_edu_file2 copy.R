...
multiply_low_edu_df = rbind(low_edu_ego_df, low_edu_ego_df)

length(multiply_low_edu_df$egoIDcol)/(7290+(length(low_edu_ego_df$egoIDcol)*2))
...
for (each_sim in seq(1, num_sims)){
  ...
  filename_edgelist = paste("/Users/admin/Dropbox (Bansal Lab)/Casey_Bansal_Lab/ergm_behavior_change_project/ergm_nets_with_varying_prop_low_edu/low_edu_20_percent/sim_net_",each_sim,".txt", sep = "")
  ...
  filename_age = paste("/Users/admin/Dropbox (Bansal Lab)/Casey_Bansal_Lab/ergm_behavior_change_project/ergm_nets_with_varying_prop_low_edu/low_edu_20_percent/sim_net_age_attributes_",each_sim,".txt", sep = "")
  ...
  filename_gender = paste("/Users/admin/Dropbox (Bansal Lab)/Casey_Bansal_Lab/ergm_behavior_change_project/ergm_nets_with_varying_prop_low_edu/low_edu_20_percent/sim_net_gender_attributes_",each_sim,".txt", sep = "")
  ...
  filename_school_work = paste("/Users/admin/Dropbox (Bansal Lab)/Casey_Bansal_Lab/ergm_behavior_change_project/ergm_nets_with_varying_prop_low_edu/low_edu_20_percent/sim_net_school_work_attributes_",each_sim,".txt", sep = "")
  ...
  filename_home = paste("/Users/admin/Dropbox (Bansal Lab)/Casey_Bansal_Lab/ergm_behavior_change_project/ergm_nets_with_varying_prop_low_edu/low_edu_20_percent/sim_net_home_attributes_",each_sim,".txt", sep = "")
  ...
  filename_edu = paste("/Users/admin/Dropbox (Bansal Lab)/Casey_Bansal_Lab/ergm_behavior_change_project/ergm_nets_with_varying_prop_low_edu/low_edu_20_percent/sim_net_edu_attributes_",each_sim,".txt", sep = "")
